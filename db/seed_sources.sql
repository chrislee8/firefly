-- ============================================================
-- Firefly — starter source registry (tech spec §1.5 zero-cost list)
-- 12 sources with genuine public RSS feeds. Reuters/Bloomberg
-- dropped from v1 (no free-tier-licensed access). Idempotent.
-- ============================================================
...
insert into sources (name, url, feed_url, fetch_type, tier, weight, category_hint) values
  ...
  ('Anthropic News',         'https://www.anthropic.com/news',                                        'https://www.anthropic.com/news/rss.xml',                                         'rss', 1, 1.00, 'Product'),
  ('Google DeepMind Blog',   'https://deepmind.google/discover/blog/',                                'https://deepmind.google/blog/rss.xml',                                           'rss', 1, 0.95, 'Research'),
  ('Meta AI Blog',           'https://ai.meta.com/blog/',                                             'https://ai.meta.com/blog/rss/',                                                  'rss', 1, 0.90, 'Research'),
